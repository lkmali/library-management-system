...
public class ChangePasswordByAdmin extends JFrame {
...
/*
	public static void main(String[] args) {
				...
				try {
					ChangePasswordByAdmin frame = new ChangePasswordByAdmin("Change Password  ","laxman" );
...
*/
	...
	//Constructer 
	public ChangePasswordByAdmin( String title ,String username ) {
		super(title);
